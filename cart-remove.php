<?php
/* Checking that the Item_id is numeric value and then deleting the Record from users_items table */
...
/* Redirecting to products.phppage after successful insertion */
